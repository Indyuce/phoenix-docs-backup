...
![xiL4NX0](uploads/51cf2c7fc49bee569d5bda7b08fe4f7f/xiL4NX0.gif)
...
Check [this wiki page](Tool%20Restrictions) for more information.
...
This parameter determines what block is affected. `vanilla` corresponds to the block type. There are three built-in [block types](Block%20Types) in MMOCore: vanilla blocks, MMOItems custom blocks (only available when MMOItems is installed), and textured player heads/skulls.
...
| Vanilla Block   | When mining any other block.                     | `vanilla{type=DIAMOND_ORE}`        |
