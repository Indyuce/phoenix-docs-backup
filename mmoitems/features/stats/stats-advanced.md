...
Remember a potion effect is defined by three parameter: the potion effect type, a duration and a potion level.
...
You can view the Minecraft effect list in the [Spigot javadocs](https://hub.spigotmc.org/javadocs/spigot/org/bukkit/potion/PotionEffectType.html).
