...
You can modify the main MI config file to adjust how (or even if) stat changes should appear in the item lore of any upgraded item. Below is the section you will want to look at and possibly modify:
...
Using crafting stations you can create crafting recipes, which require the player to have specific ingredients and meet certain conditions. When using such a recipe players can upgrade their gear. Please check out this [wiki page]() for more information.
