This page will explain how to upgrade custom blocks to MMOItems 5.5.5 correctly. **This page only applies to users who are UPDATING their current blocks to MMOItems 5.5.5.**
...
If you have any issues with the new update make sure to ask on the [MythicMobs Discord](http://mythiccraft.io/discord) in the MMO channels.